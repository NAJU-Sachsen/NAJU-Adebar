...
public class ValidationUnitTest {
  ...
  @Test
  public void testMultiValidEmailsEmails() {
    for (String email : validEmails) {
      for (String secondEmail : validEmails) {
        String mergedEmail = email + ";" + secondEmail;
        assertThat(Validation.isEmail(mergedEmail)) //
            .describedAs("Email should be recognized as valid: %s", email) //
            .isTrue();
      }
    }
  ...
  @Test
  public void testMultiInvalidEmailsEmails() {
    for (String email : validEmails) {
      for (String secondEmail : invalidEmails) {
        String mergedEmail = email + ";" + secondEmail;
        assertThat(Validation.isEmail(mergedEmail)) //
            .describedAs("Email not should be recognized as valid: %s", email) //
            .isFalse();
