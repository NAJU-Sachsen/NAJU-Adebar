...
public class ValidationUnitTest {
    private String[] validEmails = {"max.muster@web.de", "max_muster@web.de", "max123@web.de", "max123max@web.de", "MAXIMUM@googlemail.com"};
    ...
    public void testInvalidEmails() {
        for (String email : invalidEmails) {
            Assert.isTrue(!Validation.isEmail(email), "Email should not be recognized as valid: " + email);
        }
    }
