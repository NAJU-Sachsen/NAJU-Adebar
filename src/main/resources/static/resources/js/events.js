...
$('#filter-start-type').on('change', function () {
  if ($('#filter-start-type').find('option:selected').val().toString()
      === 'none') {
...
$('#filter-end-type').on('change', function () {
  if ($('#filter-end-type').find('option:selected').val().toString()
      === 'none') {
...
$('#filter-participants-limit-type').on('change', function () {
  if ($('#filter-participants-limit-type').find(
...
$('#filter-fee-type').on('change', function () {
  if ($('#filter-fee-type').find('option:selected').val().toString()
      === 'none') {
