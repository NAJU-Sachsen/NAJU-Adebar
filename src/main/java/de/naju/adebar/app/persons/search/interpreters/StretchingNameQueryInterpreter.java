package de.naju.adebar.app.persons.search.interpreters;

import de.naju.adebar.app.persons.search.PersonQueryInterpreter;
 ...
 * last name and should produce less results then the fallback
 * {@link GenericPersonQueryInterpreter}.
 *
...
public class StretchingNameQueryInterpreter extends AbstractNameQueryInterpreter {
	...
	private static final String NAME_REGEX =
			"^(?<firstName>[a-zA-ZöÖüÜäÄß]+) (([a-zA-ZöÖüÜäÄß]+(\\s*-?\\s*[a-zA-ZöÖüÜäÄß])?)+\\s)*(?<lastName>[a-zA-ZöÖüÜäÄß]+)$";
