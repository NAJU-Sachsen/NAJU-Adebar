package de.naju.adebar.app.persons.search;

import com.querydsl.core.BooleanBuilder;
import de.naju.adebar.app.persons.search.interpreters.EmailQueryInterpreter;
import de.naju.adebar.app.persons.search.interpreters.FirstNameOrLastNameQueryInterpreter;
import de.naju.adebar.app.persons.search.interpreters.GenericPersonQueryInterpreter;
import de.naju.adebar.app.persons.search.interpreters.NameQueryInterpreter;
import de.naju.adebar.app.persons.search.interpreters.PhoneNumberQueryInterpreter;
...
public class PersonQueryInterpreterHierarchy implements QueryInterpreterHierarchy<BooleanBuilder> {
	...
	public PersonQueryInterpreterHierarchy(GenericPersonQueryInterpreter genericInterpreter,
		...
		/*
		 * The name interpreter MUST be added before the first name/last name one as a complete name is
		 * a "special case" of just a first name or last name.
		 */
