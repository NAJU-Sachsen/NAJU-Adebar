...
public class NewsletterDataProcessor {
  ...
  /**
   * Concatenates all subscribers of the newsletters given and returns them as one large {@code
   * String}. This may be especially useful, when used as recipients of emails.
   *
