...
public interface ProjectManager {
     ...
     * @return the saved project. As its internal state may differ after the save, this instance should be used
    ...
    /**
     * Changes the state of a saved project. This will overwrite the complete state of the project to update
    ...
    /**
     * Changes the state of a saved project. In difference to {@link #updateProject(long, Project)} this does
     * only modify "static" information, i.e. name, start/end date and person in charge. However this does <strong>not</strong>
     * change the local group the project is associated to, as this method is primarily designed with the use case of simply
     * changing a project's name or period in mind.
     * @param projectId the identifier of the project to update
     ...
     * @return an optional containing the project if such a project exists, otherwise the optional is empty
     */
