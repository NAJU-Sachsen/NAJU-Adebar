...
/**
 * Exception to indicate that the specified filter criteria contradict each other, e.g. if only activists which are no
 * activists should be considered
...
public class ConflictingFilterCriteriaException extends RuntimeException {
    ...
    public ConflictingFilterCriteriaException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
