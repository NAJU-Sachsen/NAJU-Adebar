...
/**
 * Filter for persons depending on health impairments. The filter is'fuzzy' - i.e. the health impairments do not
 * need to be exactly equal, but the person's data need to contain the health impairment specified
