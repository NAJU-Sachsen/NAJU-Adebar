...
public class ActivistFilter implements PersonFilter {
	...
	/**
	 * Creates a filter for "general activist status", i. e. whether persons have to activists (ENFORCE)
	 * or whether they may not be activists (IGNORE). 
     ...
     * @param hasJuleica whether activists have to have a (potentially invalid) Juleica card, or whether they may not
     * @return the activist filter
     */
     ...
     * @return the activist filter
     */
    public static ActivistFilter forJuleicaExpiryDate(LocalDate expiryDate, DateFilterType dateFilterType) {
    ...
    /**
     * This constructor should be used if activists should be filtered depending on whether they have a Juleica card or not
     * @param hasJuleica whether activists have to have a (potentially invalid) Juleica card, or whether they may not
     */
    ...
    /**
     * Filter implementation for "general activist status", i. e. whether persons have to activists (ENFORCE)
     * or whether they may not be activists (IGNORE). 
     * @author Rico Bergmann
     */
