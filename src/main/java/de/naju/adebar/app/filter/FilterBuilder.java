...
public class FilterBuilder<T> {
    ...
    /**
     * Saves a new filter for execution. However applying a filter does not preserve order, i. e. adding one filter
     * after another does <strong>not</strong> guarantee that this filter will be executed after the first one.
