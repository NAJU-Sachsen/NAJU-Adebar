 ...
 *
 * <p>
 * The dialog is divided in to parts: on for adding a completely new (unknown) qualification and one
 * for adding an existing qualification to the referent. Therefore these two cases are present in
 * this form as well (by adding attributes to represent both possible states). However part of these
 * attributes will always be {@code null} (or empty) as the data actually submitted was for the
 * other case
 *
...
public class AddQualificationForm {
   ...
   */
  //@formatter:on
	public AddQualificationForm(String newQualificationName, String newQualificationDescription) {
	...
	public String toString() {
		return "AddQualificationForm [" + "newQualificationName='" + newQualificationName + '\''
	 ...
	 */
	public enum AddType {
		NEW_QUALIFICATION, EXISTING_QUALIFICATION
	}
