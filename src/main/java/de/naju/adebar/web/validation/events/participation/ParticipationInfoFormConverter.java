...
@Service
public class ParticipationInfoFormConverter
		implements ValidatingEntityFormConverter<EventBuilder, ParticipationInfoForm> {
	...
	public void applyFormToEntity(ParticipationInfoForm form, EventBuilder entity) {
		...
		entity.specifyParticipationInfo().specifyArrivalOptions(form.getArrivalOptions())
		...
		entity.specifyParticipantsList().specifyParticipantsLimit(form.getParticipantsLimit());
	}
