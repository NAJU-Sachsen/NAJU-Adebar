...
public class AddEventFormConverter implements ValidatingEntityFormConverter<Event, AddEventForm> {
  ...
  public boolean isValid(AddEventForm form) {
    if (form.isCustomAccommodation() && !accommodationFormConverter
        .isValid(form.getAccommodation())) {
      return false;
    }
  ...
  public void validate(Object target, @NonNull Errors errors) {
    ...
    if (form.isCustomAccommodation()) {
      try {
        ...
        ValidationUtils
            .invokeValidator(accommodationFormConverter, form.getAccommodation(), errors);
      } finally {
