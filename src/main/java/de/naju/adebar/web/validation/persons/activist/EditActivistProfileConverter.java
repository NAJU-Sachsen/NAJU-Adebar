...
/**
 * Simple service to apply the data from an {@link EditActivistProfileForm} to
 * {@link ActivistProfile} objects.
 *
 * @author Rico Bergmann
 */
@Service
public class EditActivistProfileConverter
		implements ValidatingEntityFormConverter<ActivistProfile, EditActivistProfileForm> {
