 ...
 */
@Service
public class AddQualificationFormConverter
		implements ValidatingEntityFormConverter<Qualification, AddQualificationForm> {
	 ...
	 * Full constructor
	 *
	 * @param qualificationRepo repository containing all qualifications which are currently available
	 */
	public AddQualificationFormConverter(QualificationRepository qualificationRepo) {
	...
	public void validate(Object target, Errors errors) {
		...
		if (form.getAddType() == AddType.EXISTING_QUALIFICATION) {
			...
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "newQualificationDescription",
					"field.required");
		}
