...
/**
 * Simple service to apply the data from an {@link EditParticipantForm} to
 * {@link ParticipantProfile} objects.
 *
 * @author Rico Bergmann
 */
@Service
public class EditParticipantFormConverter
		implements ValidatingEntityFormConverter<ParticipantProfile, EditParticipantForm> {
	...
	@BusinessRule
	@DesignSmell(
			description = "The converter should not be responsible for expressing business rules",
