...
public class AddPersonForm {
	 ...
	 */
	public AddPersonForm(String firstName, String lastName, Email email, PhoneNumber phone,
			AddressForm address, boolean marketingOptOut) {
	...
	public String toString() {
		return "AddPersonForm [" + "firstName='" + firstName + '\'' + ", lastName='" + lastName + '\''
				+ ", email=" + email + ", phone=" + phone + ", address=" + address + ", activist="
				+ activist + ", activistForm=" + activistForm + ", participant=" + participant
				+ ", participantForm=" + participantForm + ", referent=" + referent + ", referentForm="
				+ referentForm + ']';
	}
