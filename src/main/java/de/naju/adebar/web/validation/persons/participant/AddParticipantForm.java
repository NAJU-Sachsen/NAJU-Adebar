 ...
 *
 * <p>
 * As it shares much of its internal structure (i.e. the data being submitted) with the
 * {@link EditParticipantForm}, it is made a subclass. This is only natural as well: an
 * {@code AddXyzForm} may be considered a special case of an {@code EditXyzForm}. Whether creating
 * is a special case of editing or vice-versa is a philosophical question which sadly cannot be
 * answered here.
 *
...
public class AddParticipantForm extends EditParticipantForm {
	 ...
	 */
	public AddParticipantForm(Gender gender, LocalDate dateOfBirth, String eatingHabits,
			String healthImpairments, NabuMembershipInformation nabuMembership, String remarks) {
	...
	public String toString() {
		return "AddParticipantForm [" + "events=" + events + "], " + super.toString();
	}
}
