...
public class ParticipationInfoForm {
  ...
  public ParticipationInfoForm(Capacity participantsLimit,
      Age minParticipantAge, Money intParticipationFee,
      Money extParticipationFee,
  ...
  public String toString() {
    return "ParticipationInfoForm [" +
        "participantsLimit=" + participantsLimit +
        ", minParticipantAge=" + minParticipantAge +
        ", intParticipationFee=" + intParticipationFee +
        ", extParticipationFee=" + extParticipationFee +
