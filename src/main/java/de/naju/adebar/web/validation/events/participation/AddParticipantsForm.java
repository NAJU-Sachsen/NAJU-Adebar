 ...
 * <ul>
 * <li>The most recently added participant's data will be directly available through the normal
 * fields.</li>
 * <li>The data of all participant's that were added before (hereafter referred to as "in queue")
 * will be stored in lists, with one list dedicated to each field.</li>
 * </ul>
...
public class AddParticipantsForm {
	 ...
	 * times (however the validation itself will not be performed in this class, but in the
	 * {@link AddParticipantFormConverter} instead. The scope of this class is purely to capture data,
	...
	/**
	 * @param additionalFormSent whether the persons in the queue have received the registration form
	 *        already
	 */
	...
	/**
	 * @param additionalFormFilled whether the persons in the queue have signed the registration form
	 *        already
	 */
	...
	/**
	 * @param additionalMayGoHomeSingly whether the participants in the queue may leave the event on
	 *        their own
	 */
	...
	/**
	 * @param formFilled whether the current participant has filled and signed the registration form
	 */
	...
	public List<AddParticipantForm> getParticipants() {
		...
		/*
		 * Depending on the event this form is created for, some fields may not be needed E.g.if the
		 * event does not allow flexible participation times, none will be present in the form as well.
		 * However if the additional participants should be converted, all potential data needs to be
		 * available. Therefore these "optional" lists need to be filled with null elements.
		 */
		...
		for (int i = 0; i < additionalParticipants.size(); ++i) {
			participants.add(new AddParticipantForm(additionalParticipants.get(i), //
		...
		if (participant != null) {
			participants.add(new AddParticipantForm(participant, //
					formSent, //
					formFilled, //
					feePayed, //
					arrival, //
	...
	public String toString() {
		return "AddParticipantsForm [" + "additionalParticipants=" + additionalParticipants
				+ ", additionalFormSent=" + additionalFormSent + ", additionalFormFilled="
				+ additionalFormFilled + ", additionalFeePayed=" + additionalFeePayed
				+ ", additionalArrival=" + additionalArrival + ", additionalDeparture="
				+ additionalDeparture + ", additionalMayGoHomeSingly=" + additionalMayGoHomeSingly
				+ ", additionalFirstNight=" + additionalFirstNight + ", additionalLastNight="
				+ additionalLastNight + ", additionalRemarks=" + additionalRemarks + ", participant="
				+ participant + ", formSent=" + formSent + ", formFilled=" + formFilled + ", feePayed="
				+ feePayed + ", arrival=" + arrival + ", departure=" + departure + ", mayGoHomeSingly="
				+ mayGoHomeSingly + ", firstNight=" + firstNight + ", lastNight=" + lastNight
				+ ", remarks='" + remarks + '\'' + ']';
	}
	...
	public static class AddParticipantForm {
		 ...
		 *
		 * @param event the event. May be {@code null} to skip intialization of {@code firstNight} and
		 *        {@code lastNight}.
		 */
		 ...
		 */
		AddParticipantForm(Person participant, boolean formSent, boolean formFilled, boolean feePayed,
				ArrivalOption arrival, ArrivalOption departure, boolean mayGoHomeSingly,
		...
		@Override
		public String toString() {
			return "AddParticipantForm [" + "participant=" + participant + ", formSent=" + formSent
					+ ", formFilled=" + formFilled + ", feePayed=" + feePayed + ", arrival=" + arrival
					+ ", departure=" + departure + ", mayGoHomeSingly=" + mayGoHomeSingly + ", firstNight="
					+ firstNight + ", lastNight=" + lastNight + ", remarks='" + remarks + '\'' + ']';
		}
	}
