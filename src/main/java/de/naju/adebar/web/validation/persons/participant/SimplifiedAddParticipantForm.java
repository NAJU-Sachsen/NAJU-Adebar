...
public class SimplifiedAddParticipantForm implements NewOrExistingEntityForm {
	...
	/**
	 * @param newRetainAddress whether the new person should reuse the address of some other existing
	 *        person
	 */
	...
	public String toString() {
		return "SimplifiedAddParticipantForm [" + "existingPerson=" + existingPerson
				+ ", newFirstName='" + newFirstName + '\'' + ", newLastName='" + newLastName + '\''
				+ ", newDateOfBirth=" + newDateOfBirth + ", newGender=" + newGender + ", newRetainAddress="
				+ newRetainAddress + ']';
	}
