...
public class EditEventFormConverter implements ValidatingEntityFormConverter<Event, EditEventForm> {
	...
	public EditEventForm toForm(Event entity) {
		...
		ParticipationInfoForm participationInfoForm =
				new ParticipationInfoForm(entity.getParticipantsList().getParticipantsLimit(),
	...
	public void applyFormToEntity(EditEventForm form, Event entity) {
		...
		participationInfoFormConverter.applyFormToEntity(form.getParticipationInfo(),
				entity.getParticipationInfo());
