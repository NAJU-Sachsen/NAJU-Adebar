 ...
 *
 * <p>
 * This may for example be a form which offers two tabs - one for searching for an entity and one to
 * create a new entity. By using a form which implements this interface, the converter may actually
 * do the tedious task of deciding what action to perform based on the input data automatically.
 *
