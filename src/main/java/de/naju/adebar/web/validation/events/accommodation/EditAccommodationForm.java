...
public class EditAccommodationForm {
	...
	public EditAccommodationForm(Event event) {
		if (event != null && event.getParticipantsList().hasAccommodationInfo()) {
			...
			flexibleParticipationTimes =
					event.getParticipationInfo().supportsFlexibleParticipationTimes();
	...
	public String toString() {
		return "EditAccommodationForm [" + "roomCapacities=" + roomCapacities + ", roomTypes="
				+ roomTypes + ", flexibleParticipationTimes=" + flexibleParticipationTimes
