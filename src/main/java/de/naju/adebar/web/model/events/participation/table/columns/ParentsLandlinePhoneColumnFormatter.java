...
/**
 * Formatter used in the {@link ParticipantsTable} to display the landline phone numbers of parents.
 *
 * @author Rico Bergmann
 */
@Service
public class ParentsLandlinePhoneColumnFormatter implements TableColumnFormatter {
	...
	public String formatColumnFor(Person participant, Event event) {
		...
		parents //
				.map(Person::getParentProfile) //
				.filter(ParentProfile::hasLandlinePhone) //
				.map(par -> par.getLandlinePhone().getValue()) //
				.distinct() //
