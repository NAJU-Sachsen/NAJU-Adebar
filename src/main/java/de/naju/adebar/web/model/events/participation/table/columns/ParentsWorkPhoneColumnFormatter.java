...
/**
 * Formatter used in the {@link ParticipantsTable} to display the parents' phone numbers at work.
 *
 * @author Rico Bergmann
 */
@Service
public class ParentsWorkPhoneColumnFormatter implements TableColumnFormatter {
  ...
  public String formatColumnFor(Person participant, Event event) {
    ...
    parents //
        ...
        .filter(ParentProfile::hasWorkPhone) //
        .map(par -> par.getWorkPhone().getValue()) //
        .distinct() //
