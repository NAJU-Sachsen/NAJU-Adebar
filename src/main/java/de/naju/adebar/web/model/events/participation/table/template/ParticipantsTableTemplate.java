...
public class ParticipantsTableTemplate implements Serializable {
	 ...
	 * directly. Thus the PK data has to be moved into a separate ID type. However we also do not
	 * really want to deal with this type and keep its existence completely hidden for the outside.
	 */
	 ...
	 * @param columns the {@link ParticipantsTable#ALL_COLUMNS columns} the table should contain. May
	 *        not be {@code null} nor may it contain any {@code null} elements.
	 */
	...
	public static class TemplateBuilder {
		 ...
		 *
		 * @param name the name. May not be {@code null} nor empty. Names need to be unique per user.
		 ...
		 *
		 * @param content the columns. They need to correspond to the elements of
		 *        {@link ParticipantsTable#ALL_COLUMNS}.
