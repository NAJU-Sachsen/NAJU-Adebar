 ...
 *
 * <p>
 * All modification methods are handled by dedicated controllers
 *
...
public class ActivistReferentController {
	 ...
	 *
	 * <p>
	 * The controller needs access to the repositories in order to check whether a person is an
	 ...
	 */
	public ActivistReferentController(ActivistProfileRepository activistRepo,
	...
	/**
	 * Puts all referent related data into the model. Works analogous to
	 * {@link #fillModelWithActivistData(PersonId, Model)} for the most part.
	 *
