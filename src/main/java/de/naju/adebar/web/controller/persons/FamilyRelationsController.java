...
public class FamilyRelationsController {
	 ...
	 *
	 * @param person the person from which should be searched. This person will never be part of the
	 *        result set (which makes sense as persons may never be parents, siblings or children of
	 *        themselves)
	...
	public String searchPersons(@PathVariable("id") Person person,
		...
		redirAttr.addFlashAttribute("matchingPersons", searchServer.runQuery(query.trim(), person));
