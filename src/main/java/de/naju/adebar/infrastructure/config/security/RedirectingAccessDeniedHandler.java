 ...
 * @see <a href="https://stackoverflow.com/a/41633492/5161760">https://stackoverflow.com/a/41633492/5161760</a>
 */
@Component
public class RedirectingAccessDeniedHandler implements AccessDeniedHandler {
  ...
  public void handle(HttpServletRequest request, HttpServletResponse response,
    ...
    if (!response.isCommitted() && accessDeniedException instanceof InvalidCsrfTokenException) {
      request.logout();
