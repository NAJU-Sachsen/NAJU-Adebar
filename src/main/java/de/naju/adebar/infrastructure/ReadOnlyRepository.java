 ...
 * Works exactly like the {@link CrudRepository}, just without modifying methods. Even the JavaDoc is copied from there.
 * @author Rico Bergmann
 * @see CrudRepository
 * @see <a href="https://spring.io/blog/2011/07/27/fine-tuning-spring-data-repositories">Read-only repositories</a>
 */
@NoRepositoryBean
