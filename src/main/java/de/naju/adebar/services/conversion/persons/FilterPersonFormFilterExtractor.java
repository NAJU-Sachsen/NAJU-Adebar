...
import de.naju.adebar.app.persons.filter.predicate.ActivistFilter;
import de.naju.adebar.app.persons.filter.predicate.AddressFilter;
import de.naju.adebar.app.persons.filter.predicate.DateOfBirthFilter;
import de.naju.adebar.app.persons.filter.predicate.EatingHabitFilter;
import de.naju.adebar.app.persons.filter.predicate.EmailFilter;
import de.naju.adebar.app.persons.filter.predicate.EventParticipationFilter;
import de.naju.adebar.app.persons.filter.predicate.GenderFilter;
import de.naju.adebar.app.persons.filter.predicate.HealthImpairmentsFilter;
import de.naju.adebar.app.persons.filter.predicate.NabuMembershipFilter;
import de.naju.adebar.app.persons.filter.predicate.NameFilter;
