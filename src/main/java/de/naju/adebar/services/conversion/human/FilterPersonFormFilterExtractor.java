...
import de.naju.adebar.app.human.filter.DateOfBirthFilter;
import de.naju.adebar.app.human.filter.EatingHabitFilter;
import de.naju.adebar.app.human.filter.EmailFilter;
import de.naju.adebar.app.human.filter.GenderFilter;
import de.naju.adebar.app.human.filter.HealthImpairmentsFilter;
import de.naju.adebar.app.human.filter.NabuMembershipFilter;
import de.naju.adebar.app.human.filter.NameFilter;
import de.naju.adebar.app.human.filter.PersonFilter;
import de.naju.adebar.app.human.filter.ReferentFilter;
