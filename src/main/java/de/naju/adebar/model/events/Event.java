...
public class Event {
  ...
  public void setStartTime(LocalDateTime startTime) {
    ...
    // If an instance is re-initialized from database, JPA will use it's empty constructor and set
    // all the fields
    // afterwards. Therefore end time may be null and we must check this before validating the start
    // date
    if (endTime != null) {
  ...
  public void setEndTime(LocalDateTime endTime) {
    ...
    // If an instance is re-initialized from database, JPA will use it's empty constructor and set
    // all the fields
    // afterwards. Therefore start time may be null and we must check this before validating the end
    // date
    if (startTime != null) {
      Assert.isTrue(!endTime.isBefore(startTime), "Start time may not be after end time");
    }
  ...
  /**
   * @param personsToContact all persons that should be contacted for the event, in a map as {@code
   * person -> remark}
   */
