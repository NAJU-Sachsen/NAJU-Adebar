...
public class CounselorInfo implements ParticipationInfoWithDynamicTime {
	 ...
	 *
	 * @param participationTime the time. If {@code null} is passed, it will be treated as "does not
	 *        differ from the span the event takes place".
	 */
	...
	public String toString() {
		return "CounselorInfo [" + "arrivalOption=" + arrivalOption + ", departureOption="
				+ departureOption + ", remarks='" + remarks + '\'' + ", participationTime="
				+ participationTime + ']';
	}
	...
	public static class CounselorInfoBuilder {
		...
		public CounselorInfoBuilder fromInfo(CounselorInfo existingInfo) {
			this.infoUnderConstruction = new CounselorInfo(existingInfo.arrivalOption,
					existingInfo.departureOption, existingInfo.remarks, existingInfo.participationTime);
			return this;
		}
