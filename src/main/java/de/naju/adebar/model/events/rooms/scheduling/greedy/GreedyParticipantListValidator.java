...
public class GreedyParticipantListValidator implements ParticipantListValidator {
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.naju.adebar.model.events.rooms.scheduling.ParticipantListValidator#
	 * assessScheduleReliability( )
	 */
	@Override
	...
	public boolean isBookedOut() {
		Assert2.state().noNullArguments("Scheduler must be invoked first", femaleRooms, maleRooms,
				otherRooms);
