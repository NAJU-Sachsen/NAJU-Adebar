...
public class ParticipantsList extends AbstractEventInfo implements Iterable<Person> {
  ...
  /**
   * Calculates the ratio of occupied beds. This only works reliably if flexible participation times are disabled.
   * <p>
   * If the accommodation is specified, the ration will be based on it rather than a participants limit.
   * <p>
   * In case there are neither participants limit nor accommodation information, {@code 0} will be returned.
   */
