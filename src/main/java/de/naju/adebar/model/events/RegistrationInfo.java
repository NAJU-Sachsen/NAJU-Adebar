...
public class RegistrationInfo implements ParticipationInfoWithDynamicTime {
  ...
  private RegistrationInfo(boolean acknowledged, boolean participationFeePayed,
      boolean registrationFormSent, boolean registrationFormFilled,
      ArrivalOption arrivalOption, ArrivalOption departureOption, boolean mayGoHomeSingly,
      String remarks,
   ...
   *
   * @param participationTime the time. A {@code null} value indicates that the span does not
   *     differ from the period that the event takes place.
   */
  ...
  public static class RegistrationInfoBuilder {
    ...
    public RegistrationInfoBuilder fromRegistration(RegistrationInfo existingInfo) {
      ...
      this.infoUnderConstruction = new RegistrationInfo(
          existingInfo.acknowledged,
          existingInfo.participationFeePayed,
          existingInfo.registrationFormSent,
          existingInfo.registrationFormFilled,
          existingInfo.arrivalOption,
          existingInfo.departureOption,
          existingInfo.mayGoHomeSingly,
          existingInfo.remarks,
          existingInfo.participationTime,
          existingInfo.registrationDate
      );
      return this;
    }
