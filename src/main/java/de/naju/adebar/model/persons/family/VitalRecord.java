...
public interface VitalRecord {
	 ...
	 *
	 * <p>
	 * Note that this currently requires at least one parent of the person to be known as relatives
	 * are saved in terms of their parent-child relationship. All other relations are inferred from
	 * this one.
	 *
	 * <p>
	 * This also means, that {@code addSiblingTo(p, s) == addSiblingTo(s, p)} and after saving one
