 ...
 * society. For now we only need to keep track of Juleica-cards and their expiry dates.
...
public class ActivistProfile implements Cloneable {
    ...
    @Embedded @Column(name = "juleica") private JuleicaCard juleicaCard;
    ...
    /**
     * @return the activist's Juleica card. May be {@code null} if the person does not have a Juleica card
     */
    ...
    /**
     * @param juleicaCard the activist's Juleica card. May be {@code null} if the person does not have a Juleica card
     */
