...
public class ReferentProfile {
    ...
    @ManyToMany(cascade = CascadeType.ALL) private Map<String, Qualification> qualifications;
    ...
    public boolean hasQualification(Qualification qualification) {
        // a qualification's name is guaranteed to be unique. Therefore we only need to check for the key
