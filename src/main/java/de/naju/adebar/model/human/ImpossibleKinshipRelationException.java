...
/**
 * Exception to indicate that a kinship relation is not possible, e.g. when a person should be registered as its own parent
...
public class ImpossibleKinshipRelationException extends RuntimeException {
	...
	public ImpossibleKinshipRelationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
