...
/**
 * Every camp participant has to fill a registration form. The corresponding data will be collected in this profile.
 * @author Rico Bergmann
 */
@Entity(name = "participant")
public class ParticipantProfile {

    @EmbeddedId @Column(name = "personId") private PersonId personId;

    @Column(name = "gender") private Gender gender;
    @Column(name = "dateOfBirth") private LocalDate dateOfBirth;
    ...
    /**
     * @return the person's eating habit (i.e. vegetarian and the like as well as food-related allergies).
     * May be {@code null}.
     */
    ...
    /**
     * @param eatingHabits the person's eating habit (i.e. vegetarian and the like as well as food-related allergies).
     * May be {@code null}.
     */
    ...
    /**
     * @return the person's health impairments (mainly non-food-related allergies like hayfever). May be {@code null}.
     */
    ...
    /**
     * @param healthImpairments the person's health impairments (mainly non-food-related allergies like hayfever).
     * May be {@code null}.
     */
    ...
    /**
     * @return information regarding the person's membership in the NABU. May be {@code null} if the person is not a
     * NABU member.
     */
    ...
    /**
     *
     * @param nabuMembership information regarding the person's membership in the NABU. May be {@code null} if the
    ...
    /**
     * @return additional remarks such as swimming permission or other information. May be {@code null}.
     */
    ...
    /**
     * @param remarks additional remarks such as swimming permission or other information. May be {@code null}.
     */
