...
/**
 * JSON-object for subscribers. In contrast to the normal {@link Subscriber}, this one does also contain (technical)
 * information about signed up newsletters - i.e. a list of newsletter id's.
