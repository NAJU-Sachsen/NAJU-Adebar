...
/**
 * POJO for the criteria for a person filter used by the API.
 * As this may and in the future very likely also will differ from the filters used by the UI,
 * a separate POJO is used.
