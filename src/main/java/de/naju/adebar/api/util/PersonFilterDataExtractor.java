...
import de.naju.adebar.app.filter.legacy.FilterType;
import de.naju.adebar.app.filter.legacy.MatchType;
import de.naju.adebar.app.persons.legacy.filter.stream.ActivistFilter;
import de.naju.adebar.app.persons.legacy.filter.stream.AddressFilter;
import de.naju.adebar.app.persons.legacy.filter.stream.NameFilter;
import de.naju.adebar.app.persons.legacy.filter.stream.PersonFilter;
import de.naju.adebar.app.persons.legacy.filter.stream.ReferentFilter;
